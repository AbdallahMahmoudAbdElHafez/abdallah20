    ...
    <BrowserRouter>
      ...
      <Box sx={{ mr: `${drawerWidth}px` }}>
        <Routes>
          ...
          <Route path="/customers/statement-detailed" element={<DetailedCustomerStatementPage />} />
          <Route path="/customers/:customerId/statement-detailed" element={<DetailedCustomerStatementPage />} />
