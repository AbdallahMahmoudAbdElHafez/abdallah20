...
import DetailedCustomerStatement from "../components/DetailedCustomerStatement";
...
export default function DetailedCustomerStatementPage() {
    ...
    const handleCustomerChange = (event) => {
        navigate(`/customers/${event.target.value}/statement-detailed`);
    };
    ...
    const handleDialogSubmit = () => {
        ...
        navigate({
            pathname: `/customers/${selectedCustomer}/statement-detailed`,
        ...
        <div className="container mx-auto mt-8">
            ...
            >
                <DialogTitle sx={{ textAlign: "center", fontWeight: "bold" }}>
                    كشف حساب عميل تفصيلي - اختر العميل والفترة
                </DialogTitle>
                <DialogContent>
                    <Box sx={{ mt: 2 }}>
