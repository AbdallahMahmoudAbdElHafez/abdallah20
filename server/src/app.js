...
import externalWorkOrderRoutes from './routes/externalWorkOrder.routes.js';
import externalWorkOrderMaterialRoutes from './routes/externalWorkOrderMaterial.routes.js';
import externalWorkOrderReceiptRoutes from './routes/externalWorkOrderReceipt.routes.js';
const app = express();
app.use(cors());
...
app.use("/api/external-work-orders", externalWorkOrderRoutes);
app.use("/api/external-work-order-materials", externalWorkOrderMaterialRoutes);
app.use("/api/external-work-order-receipts", externalWorkOrderReceiptRoutes);
